...
{
    Eigen::MatrixXd sc = makeScancontext(_scan_down); // v1 // info: 2d
    Eigen::MatrixXd ringkey = makeRingkeyFromScancontext( sc ); // info: 1d
    Eigen::MatrixXd sectorkey = makeSectorkeyFromScancontext( sc ); // info: 1d
    std::vector<float> polarcontext_invkey_vec = eig2stdvec( ringkey );
